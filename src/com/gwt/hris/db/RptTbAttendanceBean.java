...
/**
 * RptTbAttendanceBean is a mapping of rpt_tb_attendance Table.
 * @author sql2java
*/
public class RptTbAttendanceBean
    implements Serializable, GeneratedBean
{
	private static final long serialVersionUID = 2811845568193863620L;
    ...
    private boolean rtbaIdIsModified = false;
    private boolean rtbaIdIsInitialized = false;

    private boolean _isNew = true;

    /**
     * Prefered methods to create a RptTbAttendanceBean is via the createRptTbAttendanceBean method in RptTbAttendanceManager or
     * via the factory class RptTbAttendanceFactory create method
     */
    protected RptTbAttendanceBean()
    {
    }
     ...
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_out_longitude</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_out_photo</li>
     * <li>column size: 50</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_in_photo</li>
     * <li>column size: 50</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_out_latitude</li>
     * <li>column size: 50</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_in_latitude</li>
     * <li>column size: 50</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_in_longitude</li>
     * <li>column size: 50</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.tbs_id</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_out_time_diff</li>
     * <li>column size: 10</li>
     * <li>jdbc type returned by the driver: Types.INTEGER</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_in_time_diff</li>
     * <li>column size: 10</li>
     * <li>jdbc type returned by the driver: Types.INTEGER</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_out_note</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_in_note</li>
     * <li>column size: 500</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_out_time</li>
     * <li>column size: 8</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_in_time</li>
     * <li>column size: 8</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_date</li>
     * <li>column size: 10</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.tbe_id</li>
     * <li>column size: 10</li>
     * <li>jdbc type returned by the driver: Types.INTEGER</li>
     * </ul>
     *
    ...
    /**
     * Getter method for rtbaId.
     * <br>
     * PRIMARY KEY.<br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: rpt_tb_attendance.rtba_id</li>
     * <li>column size: 10</li>
     * <li>jdbc type returned by the driver: Types.INTEGER</li>
     * </ul>
     *
     * @return the value of rtbaId
     */
    ...
    /**
     * Setter method for rtbaId.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to rtbaId
     */
    public void setRtbaId(Integer newVal)
    {
        if ((newVal != null && rtbaId != null && (newVal.compareTo(rtbaId) == 0)) ||
            (newVal == null && rtbaId == null && rtbaIdIsInitialized)) {
            return;
        }
        rtbaId = newVal;
        rtbaIdIsModified = true;
        rtbaIdIsInitialized = true;
    }
    ...
    /**
     * Determines if the rtbaId has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isRtbaIdModified()
    {
        return rtbaIdIsModified;
    }

    /**
     * Determines if the rtbaId has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isRtbaIdInitialized()
    {
        return rtbaIdIsInitialized;
    }
    ...
    {
        return rtbaOutLongitudeIsModified 		|| rtbaOutPhotoIsModified  		|| rtbaInPhotoIsModified  		|| rtbaOutLatitudeIsModified  		|| rtbaInLatitudeIsModified  		|| rtbaInLongitudeIsModified  		|| tbsIdIsModified  		|| rtbaOutTimeDiffIsModified  		|| rtbaInTimeDiffIsModified  		|| rtbaOutNoteIsModified  		|| rtbaInNoteIsModified  		|| rtbaOutTimeIsModified  		|| rtbaInTimeIsModified  		|| rtbaDateIsModified  		|| tbeIdIsModified  		|| rtbaIdIsModified  ;
    }
     ...
     */
    public void copy(RptTbAttendanceBean bean)
    {
    ...
    public Map getDictionnary()
    {
        ...
        dictionnary.put("rtba_id", getRtbaId() == null ? "" : getRtbaId().toString());
        return dictionnary;
    }
    ...
    public String getValue(String column)
    {
        ...
        } else if ("rtba_id".equalsIgnoreCase(column) || "rtbaId".equalsIgnoreCase(column)) {
            return getRtbaId() == null ? "" : getRtbaId().toString();
        }
        return "";
    }
    ...
    {
        if (!(object instanceof RptTbAttendanceBean)) {
            return false;
        }

		RptTbAttendanceBean obj = (RptTbAttendanceBean) object;
		return new EqualsBuilder()
            ...
            .append(getRtbaId(), obj.getRtbaId())
            .isEquals();
	}
