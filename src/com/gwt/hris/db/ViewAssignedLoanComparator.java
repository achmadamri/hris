...
/**
 * Comparator class is used to sort the ViewAssignedLoanBean objects.
 * @author sql2java
 */
public class ViewAssignedLoanComparator implements Comparator
{
    /**
    ...
    /**
     * Constructor class for ViewAssignedLoanComparator.
     * <br>
     * Example:
     * <br>
     * <code>Arrays.sort(pArray, new ViewAssignedLoanComparator(ViewAssignedLoanManager.ID_TBALO_NOMINAL_TOTAL_LEFT, bReverse));<code>
     *
     * @param iType the field from which you want to sort
     * <br>
     * Possible values are:
     * <ul>
     *   <li>ViewAssignedLoanManager.ID_TBALO_NOMINAL_TOTAL_LEFT
     *   <li>ViewAssignedLoanManager.ID_TBC_LOCAL_CURRENCY_KURS
     *   <li>ViewAssignedLoanManager.ID_TBC_NAME
     *   <li>ViewAssignedLoanManager.ID_TBC_CURRENCY_ID
     *   <li>ViewAssignedLoanManager.ID_TBALO_STATUS
     *   <li>ViewAssignedLoanManager.ID_TBALO_COMMENTS
     *   <li>ViewAssignedLoanManager.ID_TBALO_MONTHLY_PAYMENT
     *   <li>ViewAssignedLoanManager.ID_TBALO_NOMINAL_TOTAL
     *   <li>ViewAssignedLoanManager.ID_TBALO_TENOR
     *   <li>ViewAssignedLoanManager.ID_TBALO_INTEREST
     *   <li>ViewAssignedLoanManager.ID_TBALO_NOMINAL
     *   <li>ViewAssignedLoanManager.ID_TBALO_END_DATE
     *   <li>ViewAssignedLoanManager.ID_TBALO_START_DATE
     *   <li>ViewAssignedLoanManager.ID_TBALO_UPDATED_TIME
     *   <li>ViewAssignedLoanManager.ID_TBALO_CREATED_TIME
     *   <li>ViewAssignedLoanManager.ID_TBALO_NAME
     *   <li>ViewAssignedLoanManager.ID_TBC_ID
     *   <li>ViewAssignedLoanManager.ID_TBALO_ID
     *   <li>ViewAssignedLoanManager.ID_TBE_NAME
     *   <li>ViewAssignedLoanManager.ID_TBE_EMPLOYEE_ID
     *   <li>ViewAssignedLoanManager.ID_TBE_ID
     * </ul>
     */
    public ViewAssignedLoanComparator(int iType)
    {
        this(iType, false);
    }
     ...
     */
    public ViewAssignedLoanComparator(int iType, boolean bReverse)
    {
        this.iType = iType;
    ...
    {
        ViewAssignedLoanBean b1 = (ViewAssignedLoanBean)pObj1;
        ViewAssignedLoanBean b2 = (ViewAssignedLoanBean)pObj2;
        int iReturn = 0;
        switch(iType)
        {
            case ViewAssignedLoanManager.ID_TBALO_NOMINAL_TOTAL_LEFT:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBC_LOCAL_CURRENCY_KURS:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBC_NAME:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBC_CURRENCY_ID:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_STATUS:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_COMMENTS:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_MONTHLY_PAYMENT:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_NOMINAL_TOTAL:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_TENOR:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_INTEREST:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_NOMINAL:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_END_DATE:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_START_DATE:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_UPDATED_TIME:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_CREATED_TIME:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_NAME:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBC_ID:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBALO_ID:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBE_NAME:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBE_EMPLOYEE_ID:
                ...
                break;
            case ViewAssignedLoanManager.ID_TBE_ID:
