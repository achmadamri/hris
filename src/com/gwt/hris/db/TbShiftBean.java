...
/**
 * TbShiftBean is a mapping of tb_shift Table.
 * @author sql2java
*/
public class TbShiftBean
    implements Serializable, GeneratedBean
{
    ...
    /**
     * Prefered methods to create a TbShiftBean is via the createTbShiftBean method in TbShiftManager or
     * via the factory class TbShiftFactory create method
     */
    protected TbShiftBean()
    {
    }
     ...
     * <ul>
     * <li>full name: tb_shift.tbs_default</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: tb_shift.tbs_out_time</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: tb_shift.tbs_in_time</li>
     * <li>column size: 45</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: tb_shift.tbs_name</li>
     * <li>column size: 45</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: tb_shift.tbs_shift_id</li>
     * <li>column size: 45</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: tb_shift.tbs_id</li>
     * <li> imported key: rpt_tb_attendance.tbs_id</li>
     * <li> imported key: tb_employee_shift.tbs_id</li>
     * <li>column size: 10</li>
     * <li>jdbc type returned by the driver: Types.INTEGER</li>
     * </ul>
     *
    ...
    {
        return tbsDefaultIsModified 		|| tbsOutTimeIsModified  		|| tbsInTimeIsModified  		|| tbsNameIsModified  		|| tbsShiftIdIsModified  		|| tbsIdIsModified  ;
    }
     ...
     */
    public void copy(TbShiftBean bean)
    {
    ...
    {
        if (!(object instanceof TbShiftBean)) {
            return false;
        }

		TbShiftBean obj = (TbShiftBean) object;
