...
/**
 * ViewMenuBean is a mapping of view_menu Table.
 * @author sql2java
*/
public class ViewMenuBean
    implements Serializable, GeneratedBean
{
    ...
    /**
     * Prefered methods to create a ViewMenuBean is via the createViewMenuBean method in ViewMenuManager or
     * via the factory class ViewMenuFactory create method
     */
    protected ViewMenuBean()
    {
    }
     ...
     * <ul>
     * <li>full name: view_menu.tbm_nama_parent</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_menu.tbm_disabled</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_menu.tbm_index</li>
     * <li>column size: 45</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_menu.tbm_nama</li>
     * <li>column size: 45</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_menu.tbm_parent_id</li>
     * <li>column size: 10</li>
     * <li>jdbc type returned by the driver: Types.INTEGER</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_menu.tbm_id</li>
     * <li>column size: 10</li>
     * <li>jdbc type returned by the driver: Types.INTEGER</li>
     * </ul>
     *
    ...
    {
        return tbmNamaParentIsModified 		|| tbmDisabledIsModified  		|| tbmIndexIsModified  		|| tbmNamaIsModified  		|| tbmParentIdIsModified  		|| tbmIdIsModified  ;
    }
     ...
     */
    public void copy(ViewMenuBean bean)
    {
    ...
    {
        if (!(object instanceof ViewMenuBean)) {
            return false;
        }

		ViewMenuBean obj = (ViewMenuBean) object;
