...
/**
 * ViewReportEmployeeInformation2Bean is a mapping of view_report_employee_information_2 Table.
 * @author sql2java
*/
public class ViewReportEmployeeInformation2Bean
    implements Serializable, GeneratedBean
{
    ...
    /**
     * Prefered methods to create a ViewReportEmployeeInformation2Bean is via the createViewReportEmployeeInformation2Bean method in ViewReportEmployeeInformation2Manager or
     * via the factory class ViewReportEmployeeInformation2Factory create method
     */
    protected ViewReportEmployeeInformation2Bean()
    {
    }
     ...
     * <ul>
     * <li>full name: view_report_employee_information_2.tbae_major</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_report_employee_information_2.tbe_name</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_report_employee_information_2.tbe_id</li>
    ...
    {
        return tbaeMajorIsModified 		|| tbeNameIsModified  		|| tbeIdIsModified  ;
    }
     ...
     */
    public void copy(ViewReportEmployeeInformation2Bean bean)
    {
    ...
    {
        if (!(object instanceof ViewReportEmployeeInformation2Bean)) {
            return false;
        }

		ViewReportEmployeeInformation2Bean obj = (ViewReportEmployeeInformation2Bean) object;
