...
/**
 * ViewReportAttendanceBean is a mapping of view_report_attendance Table.
 * @author sql2java
*/
public class ViewReportAttendanceBean
    implements Serializable, GeneratedBean
{
	private static final long serialVersionUID = -2123389288155848940L;
	
    private Integer countTbsName;

    private boolean countTbsNameIsModified = false;
    private boolean countTbsNameIsInitialized = false;
    ...
    /**
     * Prefered methods to create a ViewReportAttendanceBean is via the createViewReportAttendanceBean method in ViewReportAttendanceManager or
     * via the factory class ViewReportAttendanceFactory create method
     */
    protected ViewReportAttendanceBean()
    {
    }

    /**
     * Getter method for countTbsName.
     * <br>
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_report_attendance.count_tbs_name</li>
     * <li>column size: 10</li>
     * <li>jdbc type returned by the driver: Types.INTEGER</li>
     * </ul>
     *
     * @return the value of countTbsName
     */
    ...
    /**
     * Setter method for countTbsName.
     * <br>
     * The new value is set only if compareTo() says it is different,
     * or if one of either the new value or the current value is null.
     * In case the new value is different, it is set and the field is marked as 'modified'.
     *
     * @param newVal the new value to be assigned to countTbsName
     */
    public void setCountTbsName(Integer newVal)
    {
        if ((newVal != null && countTbsName != null && (newVal.compareTo(countTbsName) == 0)) ||
            (newVal == null && countTbsName == null && countTbsNameIsInitialized)) {
            return;
        }
        countTbsName = newVal;
        countTbsNameIsModified = true;
        countTbsNameIsInitialized = true;
    }
    ...
    /**
     * Determines if the countTbsName has been modified.
     *
     * @return true if the field has been modified, false if the field has not been modified
     */
    public boolean isCountTbsNameModified()
    {
        return countTbsNameIsModified;
    }

    /**
     * Determines if the countTbsName has been initialized.
     * <br>
     * It is useful to determine if a field is null on purpose or just because it has not been initialized.
     *
     * @return true if the field has been initialized, false otherwise
     */
    public boolean isCountTbsNameInitialized()
    {
        return countTbsNameIsInitialized;
    }
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_report_attendance.tbs_name</li>
     * <li>column size: 0</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_report_attendance.tba_date</li>
     * <li>column size: 0</li>
     * <li>jdbc type returned by the driver: Types.CHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_report_attendance.tbe_name</li>
     * <li>column size: 0</li>
     * <li>jdbc type returned by the driver: Types.CHAR</li>
     * </ul>
     *
    ...
    {
        return countTbsNameIsModified 		|| tbsNameIsModified  		|| tbaDateIsModified  		|| tbeNameIsModified  ;
    }
     ...
     */
    public void copy(ViewReportAttendanceBean bean)
    {
        setCountTbsName(bean.getCountTbsName());
    ...
    public Map getDictionnary()
    {
        ...
        dictionnary.put("count_tbs_name", getCountTbsName() == null ? "" : getCountTbsName().toString());
    ...
    public String getValue(String column)
    {
        if (null == column || "".equals(column)) {
            return "";
        } else if ("count_tbs_name".equalsIgnoreCase(column) || "countTbsName".equalsIgnoreCase(column)) {
            return getCountTbsName() == null ? "" : getCountTbsName().toString();
    ...
    {
        if (!(object instanceof ViewReportAttendanceBean)) {
            return false;
        }

		ViewReportAttendanceBean obj = (ViewReportAttendanceBean) object;
		return new EqualsBuilder()
            .append(getCountTbsName(), obj.getCountTbsName())
	...
	public String toString(ToStringStyle style) {
		return new ToStringBuilder(this, style)
            .append("count_tbs_name", getCountTbsName())
