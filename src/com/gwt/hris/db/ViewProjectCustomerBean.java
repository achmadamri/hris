...
/**
 * ViewProjectCustomerBean is a mapping of view_project_customer Table.
 * @author sql2java
*/
public class ViewProjectCustomerBean
    implements Serializable, GeneratedBean
{
    ...
    /**
     * Prefered methods to create a ViewProjectCustomerBean is via the createViewProjectCustomerBean method in ViewProjectCustomerManager or
     * via the factory class ViewProjectCustomerFactory create method
     */
    protected ViewProjectCustomerBean()
    {
    }
     ...
     * <ul>
     * <li>full name: view_project_customer.tbc_description</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_project_customer.tbc_name</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_project_customer.tbc_customer_id</li>
     * <li>column size: 45</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_project_customer.tbc_id</li>
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_project_customer.tbp_description</li>
     * <li>column size: 500</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_project_customer.tbp_name</li>
     * <li>column size: 45</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_project_customer.tbp_project_id</li>
     * <li>column size: 45</li>
     * <li>jdbc type returned by the driver: Types.VARCHAR</li>
     * </ul>
     *
     ...
     * Meta Data Information (in progress):
     * <ul>
     * <li>full name: view_project_customer.tbp_id</li>
     * <li>column size: 10</li>
     * <li>jdbc type returned by the driver: Types.INTEGER</li>
     * </ul>
     *
    ...
    {
        return tbcDescriptionIsModified 		|| tbcNameIsModified  		|| tbcCustomerIdIsModified  		|| tbcIdIsModified  		|| tbpDescriptionIsModified  		|| tbpNameIsModified  		|| tbpProjectIdIsModified  		|| tbpIdIsModified  ;
    }
     ...
     */
    public void copy(ViewProjectCustomerBean bean)
    {
    ...
    {
        if (!(object instanceof ViewProjectCustomerBean)) {
            return false;
        }

		ViewProjectCustomerBean obj = (ViewProjectCustomerBean) object;
