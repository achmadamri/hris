...
public class WindowKPIApprovalAssign extends WindowMain {
	private static WindowKPIApprovalAssign instance = new WindowKPIApprovalAssign();

	NumberFormat number = NumberFormat.getFormat("0.00");

	public static WindowKPIApprovalAssign getInstance() {
		return instance;
	}

	public WindowKPIApprovalAssign() {
		window = new Window();
		window.setId("WindowKPIApprovalAssign");
		window.setSize(980, 380);
		window.setHeading("Performance : KPI Approval Assign");
	}
	...
	AsyncCallback<TbEmployeeBeanModel> getTbEmployeeApprovalAssignCallback = new AsyncCallback<TbEmployeeBeanModel>() {
		@Override
	...
	public void addComponents() {
		...
		kpiAssignInterfaceAsync.getTbEmployeeBeanApprovalAssign(getTbEmployeeApprovalAssignCallback);
		...
		proxy = new RpcProxy<PagingLoadResult<ViewKpiAssignBeanModel>>() {
			...
			protected void load(Object loadConfig, final AsyncCallback<PagingLoadResult<ViewKpiAssignBeanModel>> callback) {
				...
				interfaceAsync.getKpiApprovalAssignPaging(pagingLoadConfig, cmbEmployee.getSimpleValue(), cmbSearch.getSimpleValue(), txtSearch.getValue(), new AsyncCallback<PagingLoadResult<ViewKpiAssignBeanModel>>() {
					@Override
