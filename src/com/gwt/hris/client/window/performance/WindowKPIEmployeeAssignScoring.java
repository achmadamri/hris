...
public class WindowKPIEmployeeAssignScoring extends WindowMain {
	private static WindowKPIEmployeeAssignScoring instance = new WindowKPIEmployeeAssignScoring();

	public static WindowKPIEmployeeAssignScoring getInstance() {
		return instance;
	}

	public WindowKPIEmployeeAssignScoring() {
		window = new Window();
		window.setId("WindowKPIEmployeeAssignScoring");
	...
	AsyncCallback<ReturnBean> submitCallback = new AsyncCallback<ReturnBean>() {
		...
		public void onSuccess(ReturnBean result) {
			...
			if (result.getOperationStatus()) {
				...
				WindowKPIEmployee.getInstance().bottomToolBar.refresh();
			} else {
				MessageBox.alert("Alert", "Operation Error.<br/><br/><br/>Error Message :<br/>" + result.getMessage(), null);
			}
		}
