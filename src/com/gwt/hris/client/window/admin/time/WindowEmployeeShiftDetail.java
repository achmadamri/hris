...
public class WindowEmployeeShiftDetail extends WindowMain {
	private static WindowEmployeeShiftDetail instance = new WindowEmployeeShiftDetail();

	public static WindowEmployeeShiftDetail getInstance() {
		return instance;
	}

	public WindowEmployeeShiftDetail() {
		window = new Window();
		window.setId("WindowEmployeeShiftDetail");
		window.setSize(500, 280);
		window.setHeading("Time : Employee Shift Detail");
	}
