...
public class WindowEmployeeShift extends WindowMain {
	private static WindowEmployeeShift instance = new WindowEmployeeShift();

	public static WindowEmployeeShift getInstance() {
		return instance;
	}

	public WindowEmployeeShift() {
		window = new Window();
		window.setId("WindowEmployeeShift");
		window.setSize(740, 380);
		window.setHeading("Time : Employee Shift");
	}
	...
	public void addComponents() {
		...
		columns.add(new ColumnConfig("tbesName", "<center><b>Emp. Status</b></center>", 100));
		columns.add(new ColumnConfig("tboNama", "<center><b>Sub-Division</b></center>", 150));
