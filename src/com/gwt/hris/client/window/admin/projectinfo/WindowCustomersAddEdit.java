...
public class WindowCustomersAddEdit extends WindowMain {
	private static WindowCustomersAddEdit instance = new WindowCustomersAddEdit();

	public static WindowCustomersAddEdit getInstance() {
		return instance;
	}

	public WindowCustomersAddEdit() {
		window = new Window();
		window.setId("WindowCustomersAddEdit");
	...
	AsyncCallback<TbCustomerBeanModel> getCallback = new AsyncCallback<TbCustomerBeanModel>() {
		@Override
		public void onSuccess(TbCustomerBeanModel result) {
			if (result.getOperationStatus()) {
				hfId.setValue(result.getTbcId().toString());

				lblCode.setValue(result.getTbcCustomerId());
				txtName.setValue(result.getTbcName());
				txtaDescription.setValue(result.getTbcDescription());
	...
	AsyncCallback<ReturnBean> submitCallback = new AsyncCallback<ReturnBean>() {
		...
		public void onSuccess(ReturnBean result) {
			...
			if (result.getOperationStatus()) {
				...
				TbCustomerBeanModel beanModel = (TbCustomerBeanModel) result.get("model");
				...
				WindowCustomers.getInstance().bottomToolBar.refresh();
			} else {
				MessageBox.alert("Alert", "Operation Error.<br/><br/><br/>Error Message :<br/>" + result.getMessage(), null);
			}
		}
	...
	public void addButtons() {
		btnSave = new Button("Save", new SelectionListener<ButtonEvent>() {
			...
			public void componentSelected(ButtonEvent ce) {
				if (formPanel.isValid()) {
					...
					beanModel.setTbcDescription(StringUtil.getInstance().getString(txtaDescription.getValue()));
					interfaceAsync.submitCustomer(beanModel, submitCallback);
				} else {
		...
		btnCancel = new Button("Cancel", new SelectionListener<ButtonEvent>() {
			...
			public void componentSelected(ButtonEvent ce) {
				...
				interfaceAsync.getCustomer(id, getCallback);
