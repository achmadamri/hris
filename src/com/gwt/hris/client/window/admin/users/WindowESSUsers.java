...
public class WindowESSUsers extends WindowMain {
	private static WindowESSUsers instance = new WindowESSUsers();

	public static WindowESSUsers getInstance() {
		return instance;
	}

	public WindowESSUsers() {
		window = new Window();
		window.setId("WindowESSUsers");
			...
			public Object render(final ModelData model, String property, ColumnData config, int rowIndex, int colIndex, ListStore<ModelData> store, Grid<ModelData> grid) {
				...
				Button btnEdit = new Button("", new SelectionListener<ButtonEvent>() {
					...
					public void componentSelected(ButtonEvent ce) {
						...
						WindowESSUsersAddEdit window = WindowESSUsersAddEdit.getInstance();
						window.show("edit", id);
					}
				});
				...
				Button btnDelete = new Button("", new SelectionListener<ButtonEvent>() {
					...
					public void componentSelected(ButtonEvent ce) {
						...
						MessageBox.confirm("Confirmation", "Are you sure you want to delete ess user \"" + model.get("tblLoginId") + "\" ?", deleteListener);
					}
				});
