...
public class WindowPunchDetailMinimal extends WindowMain {
	private static WindowPunchDetailMinimal instance = new WindowPunchDetailMinimal();

	public static WindowPunchDetailMinimal getInstance() {
		return instance;
	}

	public WindowPunchDetailMinimal() {
		window = new Window();
		window.setId("WindowPunchDetail");
		window.setSize(500, 280);
		window.setHeading("Attendance Minimal : Punch XXX");
	}
		...
		public void onSuccess(ReturnBean result) {
			if (result.getOperationStatus()) {
				...
				if ("inDetail".equals(strNav)) {
					window.setHeading("Attendance Minimal : Punch In");
					...
					window.setHeading("Attendance Minimal : Punch Out");
