...
public class WindowAttendanceMinimal extends WindowMain {
	private static WindowAttendanceMinimal instance = new WindowAttendanceMinimal();

	public static WindowAttendanceMinimal getInstance() {
		return instance;
	}

	public WindowAttendanceMinimal() {
		window = new Window();
		window.setId("WindowAttendanceMinimal");
		window.setSize(830, 380);
		window.setHeading("Attendance Minimal : Attendance");
	}
				...
				if (inTime != null) {
					...
					Button btnApprovalView = new Button("", new SelectionListener<ButtonEvent>() {
						...
						public void componentSelected(ButtonEvent ce) {
							...
							WindowPunchDetailMinimal windowPunchDetailMinimal = WindowPunchDetailMinimal.getInstance();
							windowPunchDetailMinimal.show("inDetail", strDate);
						}
					});
				...
				if (outTime != null) {
					...
					Button btnApprovalView = new Button("", new SelectionListener<ButtonEvent>() {
						...
						public void componentSelected(ButtonEvent ce) {
							String strDate = model.get("tbaDate").toString();
							WindowPunchDetailMinimal windowPunchDetailMinimal = WindowPunchDetailMinimal.getInstance();
							windowPunchDetailMinimal.show("outDetail", strDate);
						}
					});
