...
public class WindowApprovalTimesheetView extends WindowMain {
	private static WindowApprovalTimesheetView instance = new WindowApprovalTimesheetView();

	public static WindowApprovalTimesheetView getInstance() {
		return instance;
	}

	public WindowApprovalTimesheetView() {
		window = new Window();
		window.setId("WindowApprovalTimesheetView");
