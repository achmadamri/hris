...
public class TbMenuAccessAdminBeanService
{
	...
	private TbMenuAccessAdminBeanService beanServices[];
	
	public TbMenuAccessAdminBeanService[] getServices() {
		return beanServices;
	}

	public void setServices(TbMenuAccessAdminBeanService[] _beanServices) {
