...
public class TbCountryBeanModel extends ReturnBean implements Serializable
{
	private static final long serialVersionUID = -3090814852926664733L;
	
	private TbCountryBeanModel beanModels[];
	
	public TbCountryBeanModel[] getModels() {
		return beanModels;
	}

	public void setModels(TbCountryBeanModel[] _beanModels) {
