...
public class ViewRenumerationBeanModel extends ReturnBean implements Serializable
{
	private static final long serialVersionUID = -5392207471294970754L;
	
	private ViewRenumerationBeanModel beanModels[];
	
	public ViewRenumerationBeanModel[] getModels() {
		return beanModels;
	}

	public void setModels(ViewRenumerationBeanModel[] _beanModels) {
