...
public class ViewVacancyBeanService
{
	...
	private ViewVacancyBeanService beanServices[];
	
	public ViewVacancyBeanService[] getServices() {
		return beanServices;
	}

	public void setServices(ViewVacancyBeanService[] _beanServices) {
