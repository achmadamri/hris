...
public class ViewReportEmployeeInformation2BeanService
{
	...
	private ViewReportEmployeeInformation2BeanService beanServices[];
	
	public ViewReportEmployeeInformation2BeanService[] getServices() {
		return beanServices;
	}

	public void setServices(ViewReportEmployeeInformation2BeanService[] _beanServices) {
