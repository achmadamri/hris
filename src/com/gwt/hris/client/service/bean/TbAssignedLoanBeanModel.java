...
public class TbAssignedLoanBeanModel extends ReturnBean implements Serializable
{
	private static final long serialVersionUID = 4835798638794196781L;
	
	private TbAssignedLoanBeanModel beanModels[];
	
	public TbAssignedLoanBeanModel[] getModels() {
		return beanModels;
	}

	public void setModels(TbAssignedLoanBeanModel[] _beanModels) {
