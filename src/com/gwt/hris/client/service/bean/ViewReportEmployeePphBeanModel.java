...
public class ViewReportEmployeePphBeanModel extends ReturnBean implements Serializable
{
	private static final long serialVersionUID = -3529001562923432231L;
	
	private ViewReportEmployeePphBeanModel beanModels[];
	
	public ViewReportEmployeePphBeanModel[] getModels() {
		return beanModels;
	}

	public void setModels(ViewReportEmployeePphBeanModel[] _beanModels) {
