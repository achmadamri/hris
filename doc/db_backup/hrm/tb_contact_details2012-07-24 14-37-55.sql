...
insert into `hrm`.`tb_contact_details`(`tbe_id`,`tbn_id`,`tbcd_street`,`tbcd_city`,`tbcd_province`,`tbcd_zip_code`,`tbcd_home_phone`,`tbcd_mobile_phone`,`tbcd_work_phone`,`tbcd_work_email`,`tbcd_other_email`) values (6,null,null,null,null,null,null,null,null,null,null);
insert into `hrm`.`tb_contact_details`(`tbe_id`,`tbn_id`,`tbcd_street`,`tbcd_city`,`tbcd_province`,`tbcd_zip_code`,`tbcd_home_phone`,`tbcd_mobile_phone`,`tbcd_work_phone`,`tbcd_work_email`,`tbcd_other_email`) values (7,null,null,null,null,null,null,null,null,null,null);
insert into `hrm`.`tb_contact_details`(`tbe_id`,`tbn_id`,`tbcd_street`,`tbcd_city`,`tbcd_province`,`tbcd_zip_code`,`tbcd_home_phone`,`tbcd_mobile_phone`,`tbcd_work_phone`,`tbcd_work_email`,`tbcd_other_email`) values (8,null,null,null,null,null,null,null,null,null,null);
