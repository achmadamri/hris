...
insert into `tb_employee_ptt`(`tbeptt_id`,`tbptt_id`,`tbe_id`,`tbc_id`,`tbeptt_insert_time`,`tbeptt_currency_name`,`tbeptt_nominal`) values (10,165,1,56,'2012-07-16 16:26:05','Indonesian Rupiah (IDR)',9000000);
insert into `tb_employee_ptt`(`tbeptt_id`,`tbptt_id`,`tbe_id`,`tbc_id`,`tbeptt_insert_time`,`tbeptt_currency_name`,`tbeptt_nominal`) values (11,165,2,56,'2012-07-16 16:26:18','Indonesian Rupiah (IDR)',9000000);
insert into `tb_employee_ptt`(`tbeptt_id`,`tbptt_id`,`tbe_id`,`tbc_id`,`tbeptt_insert_time`,`tbeptt_currency_name`,`tbeptt_nominal`) values (13,165,6,56,'2012-01-01 23:16:13','Indonesian Rupiah (IDR)',9000000);
