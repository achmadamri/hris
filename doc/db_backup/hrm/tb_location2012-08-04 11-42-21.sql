...
insert into `tb_location`(`tbl_id`,`tbl_location_id`,`tbl_name`,`tbl_country`,`fk_tbn_id`,`tbl_province`,`tbl_city`,`tbl_address`,`tbl_zip_code`,`tbl_phone`,`tbl_fax`,`tbl_comments`) values (1,'LOC1','Kantor Cabang 1',null,100,'Jawa Barat','Bekasi','Jl. ','12345','02112345','02112345','');
insert into `tb_location`(`tbl_id`,`tbl_location_id`,`tbl_name`,`tbl_country`,`fk_tbn_id`,`tbl_province`,`tbl_city`,`tbl_address`,`tbl_zip_code`,`tbl_phone`,`tbl_fax`,`tbl_comments`) values (2,'LOC2','Kantor Cabang 2',null,100,'Jawa Barat','Bandung','Jl.','12345','','','Kantor Cabang');
