...
insert into `hrm`.`tb_kpi`(`tbk_id`,`tbkg_id`,`tbe_Id`,`tbk_description`,`tbk_target_nilai_1`,`tbk_target_nilai_2`,`tbk_target_nilai_3`,`tbk_target_nilai_4`,`tbk_target_nilai_5`,`tbk_bobot`) values (11,9,2,'Pengisian Time Report','Missing 20%','Missing 10%','Tidak ada missing','-','-',15);
...
insert into `hrm`.`tb_kpi`(`tbk_id`,`tbkg_id`,`tbe_Id`,`tbk_description`,`tbk_target_nilai_1`,`tbk_target_nilai_2`,`tbk_target_nilai_3`,`tbk_target_nilai_4`,`tbk_target_nilai_5`,`tbk_bobot`) values (13,5,2,'Soft-Skill
- Problem solving
...
insert into `hrm`.`tb_kpi`(`tbk_id`,`tbkg_id`,`tbe_Id`,`tbk_description`,`tbk_target_nilai_1`,`tbk_target_nilai_2`,`tbk_target_nilai_3`,`tbk_target_nilai_4`,`tbk_target_nilai_5`,`tbk_bobot`) values (14,5,2,'Hard-Skill
- OSB & ADF','','tidak berhasil ','','bisa digunakan untuk development','bisa demo dengan memuaskan',5);
insert into `hrm`.`tb_kpi`(`tbk_id`,`tbkg_id`,`tbe_Id`,`tbk_description`,`tbk_target_nilai_1`,`tbk_target_nilai_2`,`tbk_target_nilai_3`,`tbk_target_nilai_4`,`tbk_target_nilai_5`,`tbk_bobot`) values (15,5,2,'Certification- SOA Implementer Certified','','Tidak diambil','<= Des 2011','<= Agustus 2011','<= Juni 2011',10);
