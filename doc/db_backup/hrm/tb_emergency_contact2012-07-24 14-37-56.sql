...
insert into `hrm`.`tb_emergency_contact`(`tbec_id`,`tbe_id`,`tbec_name`,`tbec_relationship`,`tbec_home_phone`,`tbec_mobile_phone`,`tbec_work_phone`) values (251,1,'Djamaludin','Father in law','','','');
