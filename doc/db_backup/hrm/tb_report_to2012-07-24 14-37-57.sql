...
insert into `hrm`.`tb_report_to`(`tbrt_id`,`tbe_id`,`tbrt_spv`,`tbrt_reporting_method`) values (53,2,1,0);
insert into `hrm`.`tb_report_to`(`tbrt_id`,`tbe_id`,`tbrt_spv`,`tbrt_reporting_method`) values (54,5,2,0);
insert into `hrm`.`tb_report_to`(`tbrt_id`,`tbe_id`,`tbrt_spv`,`tbrt_reporting_method`) values (55,5,1,1);
insert into `hrm`.`tb_report_to`(`tbrt_id`,`tbe_id`,`tbrt_spv`,`tbrt_reporting_method`) values (56,6,2,0);
