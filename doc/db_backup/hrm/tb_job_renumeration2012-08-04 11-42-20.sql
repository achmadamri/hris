...
insert into `tb_job_renumeration`(`tbjr_id`,`tbjt_id`,`tbr_id`) values (114,241,5);
insert into `tb_job_renumeration`(`tbjr_id`,`tbjt_id`,`tbr_id`) values (115,241,6);
insert into `tb_job_renumeration`(`tbjr_id`,`tbjt_id`,`tbr_id`) values (116,242,5);
