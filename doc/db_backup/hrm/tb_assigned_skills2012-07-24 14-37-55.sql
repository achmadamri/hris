...
insert into `hrm`.`tb_assigned_skills`(`tbas_id`,`tbe_id`,`tbs_id`,`tbas_year`,`tbas_comments`) values (13,1,1,4,null);
insert into `hrm`.`tb_assigned_skills`(`tbas_id`,`tbe_id`,`tbs_id`,`tbas_year`,`tbas_comments`) values (14,1,2,2,null);
