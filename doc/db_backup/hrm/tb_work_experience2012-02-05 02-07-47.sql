...
insert into `hrm`.`tb_work_experience`(`tbwe_id`,`tbe_id`,`tbwe_work_experience_id`,`tbwe_employer`,`tbwe_job_title`,`tbwe_comments`,`tbwe_start_date`,`tbwe_end_date`,`tbwe_internal`) values (2,1,null,'PT. Sampoerna Telekomunikasi Indonesia','Technical Design Architecture','','2008-07-19 00:00:00','2010-11-23 00:00:00',1);
