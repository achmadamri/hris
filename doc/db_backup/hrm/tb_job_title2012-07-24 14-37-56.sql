...
insert into `hrm`.`tb_job_title`(`tbjt_id`,`tbjt_job_title_id`,`tbjt_name`,`tbjt_description`,`tbjt_comments`,`tbjs_id`,`tbp_id`,`tbjt_leave_entitled`) values (241,'JOB001','Job Direktur','Job Direktur Description','Job Direktur Comments',1,1,24);
insert into `hrm`.`tb_job_title`(`tbjt_id`,`tbjt_job_title_id`,`tbjt_name`,`tbjt_description`,`tbjt_comments`,`tbjs_id`,`tbp_id`,`tbjt_leave_entitled`) values (242,'JOB242','Job Manager','Job Manager Description','Job Manager Comments',2,11,15);
