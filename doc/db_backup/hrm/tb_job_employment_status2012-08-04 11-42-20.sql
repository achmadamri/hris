...
insert into `tb_job_employment_status`(`tbjes_id`,`tbjt_id`,`tbes_id`) values (125,241,241);
insert into `tb_job_employment_status`(`tbjes_id`,`tbjt_id`,`tbes_id`) values (126,241,242);
insert into `tb_job_employment_status`(`tbjes_id`,`tbjt_id`,`tbes_id`) values (127,242,241);
