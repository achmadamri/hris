...
insert into `hrm`.`tb_membership`(`tbm_id`,`tbm_membership_id`,`tbm_name`,`tbmt_id`) values (241,'MEM1','Membership 1',241);
insert into `hrm`.`tb_membership`(`tbm_id`,`tbm_membership_id`,`tbm_name`,`tbmt_id`) values (242,'MEM242','Membership 2',242);
