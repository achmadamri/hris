...
insert into `tb_company_property`(`tbcp_id`,`tbe_id`,`tbcp_nama`) values (1,null,'Laptop Acer 4745G 14". Serial: ABC001');
insert into `tb_company_property`(`tbcp_id`,`tbe_id`,`tbcp_nama`) values (15,null,'Toyota Kijang Innova 2011');
